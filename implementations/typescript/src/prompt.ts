import { Memory } from './Ai17x/models/memory';
import { Trait, Ai17xDefinition, Value } from './Ai17x/models/personality';
...
/**
 * Generates the prompt string based on the Ai17xDefinition.
 */
export function generatePrompt(data: Ai17xDefinition, formattedMemories: string): string {
